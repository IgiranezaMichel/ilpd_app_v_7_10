...
public class ClassFinder {
    ...
    public final static String[] statusListStudent = {"Active", "Suspended", "Decease", "Dropout","Displinary case", "Graduated"};
    ...
    public static List<JsonNode> findReportable(String scannedPackage){
        ...
        for (Class<?> clazz : classList){
            if( clazz.isAnnotationPresent(ReportProperty.class) ) {
                ReportProperty clazzAnnotation = clazz.getAnnotation(ReportProperty.class);
